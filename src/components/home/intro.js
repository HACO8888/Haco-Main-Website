            ...
            <div className="flex">
                ...
                <div className="items-center flex-initial m-auto text-center align-middle max-md:flex-none max-md:hidden">
                    <div className="flex flex-col gap-3">
                        <Link href="mailto:jasonytonlinecomeandsee@gmail.com" className="w-auto px-4 py-3 text-white rounded-lg bg-info" target="_blank">📩 Cooperation</Link>
                        <Link href="https://www.lazco.dev/contact" className="px-4 py-3 text-white rounded-lg bg-success" target="_blank">🗂️ Contact Lazco</Link>
                    </div>
                </div>
            </div>
            <div className="items-center m-auto mt-10 text-center align-middle md:hidden">
                <div className="flex flex-col gap-3">
                    <Link href="mailto:jasonytonlinecomeandsee@gmail.com" className="w-auto px-4 py-3 text-white rounded-lg bg-info" target="_blank">📩 Cooperatione</Link>
                    <Link href="https://www.lazco.dev/contact" className="px-4 py-3 text-white rounded-lg bg-success" target="_blank">🗂️ Contact Lazco</Link>
                </div>
            </div>
        </>
